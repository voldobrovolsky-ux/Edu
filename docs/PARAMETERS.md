...
- Связи: почти со всеми — это «кто». Журнал, Питание, Мессенджер, ИОМ, Безопасностный.
...
- Связи: Журнал/УМК, психолог (кабинет), Мероприятия, Родитель (отчёты), Мессенджер.
...
- Связи: Мероприятия, Контингентный (согласия!), Мессенджер.
...
**Мессенджер** — мессенджер Flōr Group: каналы классов, уведомления, коммуникация ролей.
- Сущности: `Channel`, `Membership`, `Message`, `NotificationPref`.
- Emits: `messenger.member.added.v1`, `messenger.message.posted.v1`.
...
> Контингентный, Кадровый, Пространственный, Мессенджер, Корпоративный.
...
outbox + idempotency + depth-guard** + Мессенджер-коннектор. Без этого каскады невозможны.
...
- **Мессенджер** — канал доставки большинства каскадов (уведомления).
...
УМК + Контингентный + Кадровый + Журнал(УМК) + Мессенджер + Пространственный-lite (бронь/кабинеты).
...
- **Журнал→ИОМ→Мессенджер→(?)→Журнал:** риск, если уведомление триггерит запись. Запрет:
  Мессенджер только доставляет, ничего не пишет обратно в учебные домены.
